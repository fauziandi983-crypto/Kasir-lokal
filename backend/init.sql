...
-- 3.5 Tabel Barang_Barcodes (Multi-Barcode Support)
...
-- 10. Tambah kolom SaaS ke Users
ALTER TABLE users ADD COLUMN IF NOT EXISTS business_id INTEGER REFERENCES business(id) ON DELETE CASCADE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS toko_id INTEGER REFERENCES toko(id) ON DELETE SET NULL;

-- 11. Tambah kolom SaaS ke tabel Master Data
ALTER TABLE pelanggan ADD COLUMN IF NOT EXISTS business_id INTEGER REFERENCES business(id) ON DELETE CASCADE;
ALTER TABLE pelanggan ADD COLUMN IF NOT EXISTS toko_id INTEGER REFERENCES toko(id) ON DELETE SET NULL;

ALTER TABLE supplier ADD COLUMN IF NOT EXISTS business_id INTEGER REFERENCES business(id) ON DELETE CASCADE;
ALTER TABLE supplier ADD COLUMN IF NOT EXISTS toko_id INTEGER REFERENCES toko(id) ON DELETE SET NULL;

ALTER TABLE barang ADD COLUMN IF NOT EXISTS business_id INTEGER REFERENCES business(id) ON DELETE CASCADE;
ALTER TABLE barang ADD COLUMN IF NOT EXISTS toko_id INTEGER REFERENCES toko(id) ON DELETE SET NULL;

ALTER TABLE transaksi ADD COLUMN IF NOT EXISTS business_id INTEGER REFERENCES business(id) ON DELETE CASCADE;
ALTER TABLE transaksi ADD COLUMN IF NOT EXISTS toko_id INTEGER REFERENCES toko(id) ON DELETE SET NULL;

ALTER TABLE log_kerugian ADD COLUMN IF NOT EXISTS business_id INTEGER REFERENCES business(id) ON DELETE CASCADE;
ALTER TABLE log_kerugian ADD COLUMN IF NOT EXISTS toko_id INTEGER REFERENCES toko(id) ON DELETE SET NULL;
